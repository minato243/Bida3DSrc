...
PhysicsDispatcher::PhysicsDispatcher(PhysicsWorldV2 * world) : _world(world), _handlerID(0) {}
...
void PhysicsDispatcher::dispatchCushionCollision(double timestamp, BallBody * ball, CushionSegment * cushion) {
